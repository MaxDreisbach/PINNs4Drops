...
class TrainDataset(Dataset):
    ...
    def __init__(self, opt, phase='train'):
        ...
        #TODO: modify GEO to only load required meshes
    ...
    def get_subjects(self):
        ...
        if self.is_train:
            #print(sorted(list(set(all_subjects) - set(var_subjects) - set(test_subjects))))
            return sorted(list(set(all_subjects) - set(var_subjects) - set(test_subjects)))
        else:
            #print(sorted(list(set(var_subjects))))
