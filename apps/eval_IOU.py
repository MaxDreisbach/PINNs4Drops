    ...
    with open(opt_log, 'w') as outfile:
        ...
        with torch.no_grad():
            ...
            if not opt.no_num_eval:
                ...
                test_errors = calc_error(opt, netG, cuda, test_dataset, opt.batch_size, plot_results=False)
                ...
                train_errors = calc_error(opt, netG, cuda, train_dataset, opt.batch_size, plot_results=False)
