    ...
    with open(opt_log, 'w') as outfile:
        ...
        with torch.no_grad():
            ...
            if not opt.no_num_eval:
                ...
                test_errors = calc_error(opt, netG, cuda, test_dataset, opt.batch_size, slice_dim=SLICE_DIM, ds='test', plot_results=True)
                ...
                train_errors = calc_error(opt, netG, cuda, train_dataset, opt.batch_size, slice_dim=SLICE_DIM, ds='train', plot_results=True)
