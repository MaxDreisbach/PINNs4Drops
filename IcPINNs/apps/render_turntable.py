...
for i, obj_path in enumerate(obj_files):
    ...
    #Hotfix to save files with broken names
    #cmd = 'ffmpeg -framerate 30 -i ' + obj_root + '/rot_%04d.png -vcodec libx264 -y -pix_fmt yuv420p -refs 16 ' + os.path.join(obj_root, str(i) + '.mp4')
    file_name.replace(" ", "_")
