...
for i, obj_path in enumerate(obj_files):
    ...
    cv2.imwrite(os.path.join(obj_root, 'rot_%04d.png' % i), 255 * img)

file_name.replace(" ", "_")
file_name = "_".join(file_name.split())
print(file_name)
cmd = 'ffmpeg -framerate 30 -i ' + obj_root + '/rot_%04d.png -vcodec libx264 -y -pix_fmt yuv420p -refs 16 ' + os.path.join(obj_root, str(obj_fold) + '_bottom.mp4')
os.system(cmd)
...
file_name = "_".join(file_name.split())
print(file_name)
cmd = 'ffmpeg -framerate 30 -i ' + obj_root + '/rot_%04d.png -vcodec libx264 -y -pix_fmt yuv420p -refs 16 ' + os.path.join(obj_root, str(obj_fold) + '_90.mp4')
os.system(cmd)
cmd = 'rm %s/rot_*.png' % obj_root
os.system(cmd)
...
file_name = "_".join(file_name.split())
print(file_name)
cmd = 'ffmpeg -framerate 30 -i ' + obj_root + '/rot_%04d.png -vcodec libx264 -y -pix_fmt yuv420p -refs 16 ' + os.path.join(obj_root, str(obj_fold) + '_0.mp4')
os.system(cmd)
cmd = 'rm %s/rot_*.png' % obj_root
os.system(cmd)