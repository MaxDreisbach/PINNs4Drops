...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_data.add_argument('--RGB', default=True, type=bool, help='train on RGB-images')
        ...
        g_train.add_argument('--num_threads', default=0, type=int, help='# sthreads for loading data/ num_workers')
        ...
        g_test.add_argument('--test_folder_path', type=str, default='../PINN-PIFu/train_data_DFS2025A/', help='the folder of test image')
        g_test.add_argument('--plot3D', action='store_true')
        ...
        g_model.add_argument('--use_LAAF', default=True, type=bool,
                             help='Use layer-wise adaptive activation functions')
        g_model.add_argument('--mlp_dim', nargs='+', default=[516, 1024, 512, 256, 128, 5], type=int,
                             help='# of dimensions of mlp')
        g_model.add_argument('--tcn_dim', nargs='+', default=[256, 256, 256, 256, 256, 256], type=int,
                             help='# of dimensions of mlp')
        g_model.add_argument('--mlp_dim_FF', nargs='+', default=[513, 1024, 512, 256, 128, 5], type=int,
                             help='# of dimensions of mlp')
        g_model.add_argument('--mlp_dim_CH2', nargs='+', default=[516, 1024, 512, 256, 128, 6],
                             type=int, help='# of dimensions of color mlp')
        g_model.add_argument('--mlp_dim_AC', nargs='+', default=[516, 1024, 512, 256, 128, 8],
                             type=int, help='# of dimensions of color mlp')
        ...
        g_model.add_argument('--eps', type=float, default=0.05,
                             help='initial interface thickness for phase-field PINNs')
        ...
        g_model.add_argument('--weight_S', default=0.1, type=float,
                             help='weight of identity for artificial mass flux S (Allen-Cahn)')
        ...
        parser.add_argument('--residual_tcn', action='store_true', help='no skip connection in TCN')
        parser.add_argument('--schedule', type=int, nargs='+', default=[6, 9, 13, 15],
                            help='Decrease learning rate at these epochs.')
        parser.add_argument('--schedule_long', type=int, nargs='+', default=[24, 34, 40, 100],
                            help='Decrease learning rate at these epochs.')
        parser.add_argument('--schedule_short', type=int, nargs='+', default=[4, 6, 8, 10],
                            help='Decrease learning rate at these epochs.')
        parser.add_argument('--onramp', type=int, default=10000, help='Data loss onramp iterations.')
        parser.add_argument('--loss_softadapt', default=True, type=bool, help='Use Softadapt loss weighting')
        parser.add_argument('--loss_inverse_weight', default=False, type=bool, help='Use inverse ratio loss weighting')
